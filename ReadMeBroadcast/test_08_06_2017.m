...
coord_eph_obj = Coord_Eph();
brd_fname='auto0010.05n';
date_in=[2005,1,1,7,14,0];
epoch=date_time(date_in);
time_interval = 15*60; % time interval between each epoch
brd_orb = broadcast_position('auto0010.05n',time_interval,coord_eph_obj);
